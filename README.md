...
# Olá, eu sou Berg Pinheiro 👋

### Dev Full Stack · Fundador da [Weblooks](https://weblooks.com.br)
...
- 🏙️ Fortaleza, CE — Brasil
- 💼 Fundador da **Weblooks** — desenvolvimento web e automações
- 🚀 Especialista em **Next.js**, **Node.js**, **TypeScript** e integrações
- 📦 Criador do **W Multi Channel** — sistema de atendimento multicanal
- ⚡ Apaixonado por código limpo, entregas no prazo e projetos que escalam
...
|---|---|---|
| **W Multi Channel** | Sistema de atendimento multicanal (WhatsApp, Instagram, e-mail) | Next.js, Node.js, WebSocket |
| **Weblooks Site** | Site institucional / portfólio pessoal | Next.js, TypeScript, Tailwind |

---

### 📫 Vamos conversar?

Estou sempre aberto a novos projetos, parcerias e conversas sobre tecnologia.

[![WhatsApp](https://img.shields.io/badge/Falar_no_WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/5585991203123?text=Ol%C3%A1%2C+Berg%21+Vi+seu+perfil+e+gostaria+de+conversar.)

---

<div align="center">
  <sub>Feito com ♥ e muito Next.js — <a href="https://weblooks.com.br">weblooks.com.br</a></sub>
</div>
